...
class JournalForm extends Component
{
    ...
    public function mount(Request $request)
    {
        ...
        if(!Str::isUuid($request->journal) && $request->journal != 'create'){
            abort(404);
        }

        if($request->journal != 'create'){
    ...
    public function render()
    {
        ...
        return view('livewire.backend.journal-form');
    }
    ...
    public function update(Journal $journal)
    {
        ...
        if(!empty($this->instruction_title)){
            JournalInstruction::where('journal_id', $journal->id)->delete();
            foreach($this->instruction_title as $key => $instruction)
            {
                $ins = new JournalInstruction;
        ...
        session()->flash('success', 'Journal has been updated successfully!');
    ...
    public function edit(Journal $journal)
    {
        ...
        $this->category    = $journal->category_id;
