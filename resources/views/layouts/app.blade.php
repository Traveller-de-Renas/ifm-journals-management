                ...
                <div class="h-full py-4 overflow-y-auto bg-[#2B579A]">
                                ...
                                <li>
                                    ...
                                    <ul id="dropdown-f" class="hidden py-2 space-y-2">
                                        ...
                                        @if(auth()->user()->hasPermissionTo('Edit Journals'))
                                            <li>
                                                <a href="{{ route('journals.create', session('journal')) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Journal Details</a>
                                            </li>
                                        @endif

                                        @if(auth()->user()->hasPermissionTo('Journal Team'))
                                        <li>
                                            <a href="{{ route('journals.team', session('journal')) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Journal Team</a>
                                        </li>
                                        @endif
                    ...
                    @if(in_array(auth()->user()->id, $ceditor) || (auth()->user()->hasRole('Administrator') && session('journal')))
                        ...
                        <ul class="space-y-2 font-medium border-t border-gray-400">
                            ...
                            <li>
                                <button type="button" class="flex items-center w-full px-4 py-2 text-base text-white hover:text-gray-950 transition duration-75 group hover:bg-gray-100" aria-controls="dropdown-a" data-collapse-toggle="dropdown-a">
                                    ...
                                    @if(($submitted + $resubmitted) > 0)
                                        <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-xs font-medium text-white bg-red-700 rounded-full">{{ $submitted + $resubmitted }}</span>
                                    @endif
                                ...
                                <ul id="dropdown-a" class="hidden py-2 space-y-2">
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'submitted']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">
                                            
                                            <span class="flex-1 text-left rtl:text-right whitespace-nowrap">New Submission</span>
                                            @if($submitted > 0)
                                                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-xs font-medium text-white bg-red-700 rounded-full">{{ $submitted }}</span>
                                            @endif
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'resubmitted']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">
                                            <span class="flex-1 text-left rtl:text-right whitespace-nowrap">Resubmissions</span>
                                            @if($resubmitted > 0)
                                                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-xs font-medium text-white bg-red-700 rounded-full">{{ $resubmitted }}</span>
                                            @endif
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                <button type="button" class="flex items-center w-full px-4 py-2 text-base text-white hover:text-gray-950 transition duration-75 group hover:bg-gray-100" aria-controls="dropdown-b" data-collapse-toggle="dropdown-b">
                                    <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                                        <path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z"/>
                                    </svg>
                                    ...
                                    @if(($onreview) > 0)
                                        <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-xs font-medium text-white bg-red-700 rounded-full">{{ $onreview }}</span>
                                    @endif
                                ...
                                <ul id="dropdown-b" class="hidden py-2 space-y-2">
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'on_review']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">
                                    ...
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'returned_to_author']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Returned to Author</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'rejected']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Rejected Paper</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'production']) }}" c class="flex items-center px-4 py-2 text-white hover:text-gray-950 hover:bg-gray-100 group">
                                    <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                                        <path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z"/>
                                    </svg>
                            ...
                            <li>
                                <button type="button" class="flex items-center w-full px-4 py-2 text-base text-white hover:text-gray-950 transition duration-75 group hover:bg-gray-100" aria-controls="dropdown-c" data-collapse-toggle="dropdown-c">
                                    <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                                        <path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z"/>
                                    </svg>
                                ...
                                <ul id="dropdown-c" class="hidden py-2 space-y-2">
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'pending_publications']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Pending for Publication</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'online_first'])  }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Online First</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('journals.publication', session('journal')) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Issue Assignment</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'published']) }}" class="flex items-center w-full p-2 text-white hover:text-gray-950 transition duration-75 pl-11 group hover:bg-gray-100">Published</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <ul class="space-y-2 font-medium border-t border-gray-400">
                        <li>
                            <a href="{{ route('journals.submission', session('journal')) }}" class="flex items-center px-4 py-2 text-white hover:text-gray-950 hover:bg-gray-100 group">
                                <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li>
                            <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'pending']) }}" class="flex items-center px-4 py-2 text-white hover:text-gray-950 hover:bg-gray-100 group">
                                <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                @if($pending > 0)
                                    <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-xs font-medium text-white bg-red-700 rounded-full">{{ $pending }}</span>
                                @endif
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'onprogress']) }}" class="flex items-center px-4 py-2 text-white hover:text-gray-950 hover:bg-gray-100 group">
                                <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li>
                            <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'returned']) }}" class="flex items-center px-4 py-2 text-white hover:text-gray-950 hover:bg-gray-100 group">
                                <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                @if($returned > 0)
                                    <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-white bg-red-700 rounded-full">{{ $returned }}</span>
                                @endif
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('journals.articles', ['journal' => session('journal'), 'status' => 'with_decisions']) }}" class="flex items-center px-4 py-2 text-white hover:text-gray-950 hover:bg-gray-100 group">
                                <svg class="flex-shrink-0 w-4 h-5 text-white transition duration-75 group-hover:text-gray-900 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
