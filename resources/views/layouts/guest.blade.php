                    ...
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <li>
                                    <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Journals</a>
                                </li>
                                <li>
                ...
                <div class="w-full">
                    <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
                        ...
                        <div class="fixed right-2 z-50 md:flex flex-col gap-2 justify-center items-center w-50 text-md hidden">
                            ...
                            <div class="relative flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-400 p-2 w-full cursor-pointer border-2">
                                @if($media->type == 'image')
