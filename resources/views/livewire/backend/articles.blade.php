                ...
                <div class="{{ $review_status == '018' ? 'hidden' : 'block' }}">
                    <div class="mt-4">
                        <x-label for="editor_comments" value="Associate Editor Comments"
                            class="mb-2 block font-medium text-sm text-gray-700" /><span class="text-xs text-red-500">Mandatory</span>
                        <x-textarea type="text" id="editor_comments" class="w-full" wire:model="editor_comments"
            ...
            <div class="mt-4 text-xs">
                ...
                @foreach ($sections as $key => $sub_sections)
                    ...
                    @foreach ($sub_sections->reviewSections as $skey => $section)
                        ...
                        <div class="mb-6">
                            ...
                            <x-textarea type="text" id="reviewComment" class="w-full mt-2 bg-gray-50"
                                wire:model="reviewComment.{{ $section->id }}" placeholder="Comments..........."
                                rows="3" readonly />
                ...
                <div class="p-4 border-b">
                    <div class="text-justify">
                        ...
                        evidence of an understanding of the research literature in the field; or a slight elaboration on
                        the
                        research findings.
                        <br><br>

                        <b>Major revisions:</b> Requires the author to make more significant improvements, the type
                        which
                    ...
                    <br>
                    <br>
                    <p class="font-bold">(Determine whether the article is publishable or not, tick the appropriate
                        box)</p>
                    ...
                    <div class="p-4 border-b">
                        <div class="mt-4 flex gap-2 flex-wrap">
                            @if (isset($review_attachments) && count($review_attachments))
                                @foreach ($review_attachments as $key => $file)
                                    <div class="flex">
                                        <a href="{{ asset('storage/review_attachments/' . $file->attachment) }}"
                                            target="_blank"
                                ...
                                @endforeach
                            @else
                                <div class="p-4 text-sm shadow bg-red-400 w-full text-center text-white rounded">
                                    No Attachment Found
                                </div>
                            @endif
                        </div>
