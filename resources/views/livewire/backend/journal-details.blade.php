...
<div class="w-full max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-12 gap-2 mt-4">
        <div class="col-span-3">
            ...
            <p class="font-bold p-2 border-b cursor-pointer text-blue-700 hover:text-blue-500" wire:click="article_status('001')"> Pending Manuscript </p>
            <p class="font-bold p-2 border-b cursor-pointer text-blue-700 hover:text-blue-500" wire:click="article_status('002')"> Submitted Manuscript </p>
            <p class="font-bold p-2 border-b cursor-pointer text-blue-700 hover:text-blue-500" wire:click="article_status('013')"> Returned Manuscript </p>
            <p class="font-bold p-2 border-b cursor-pointer text-blue-700 hover:text-blue-500" wire:click="article_status('006')"> Published Manuscript </p>
            
            <a href="{{ route('journals.submission', $record->uuid) }}">
                <p class="font-bold p-2 border-b">Start New Submission</p>
            </a>
        </div>
