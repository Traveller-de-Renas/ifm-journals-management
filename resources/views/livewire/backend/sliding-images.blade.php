<div class="bg-white shadow-md p-4 rounded">
    <div class="w-full grid grid-cols-3 gap-4" >
        <div class="">
            <p class="font-bold text-xl">{{ __('SLIDING IMAGES') }}</p>
        </div>
        <div class="">
    ...
    <x-dialog-modal wire:model="Delete">
        ...
        <x-slot name="footer">
            ...
            <x-button class="bg-red-500 hover:bg-red-700" type="submit" wire:click="delete({{ $record }})" wire:loading.attr="disabled" >
                {{ __('Delete') }}
            </x-button>
