<div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-2 ">
                ...
                <div class="col-span-10 w-full mb-2 mt-2">
                    ...
                    <div class="mb-2">
                        <div class="text-sm">
                            {{ $journal->chief_editor?->salutation?->title }} {{ $journal->chief_editor?->first_name }} {{ $journal->chief_editor?->middle_name }} {{ $journal->chief_editor?->last_name }} 
                            {{ $journal->chief_editor?->affiliation != '' ? '('. $journal->chief_editor?->affiliation.')' : '' }}
                        </div>
                    </div>
    ...
    <div class="w-full max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4 mb-12">
        ...
        <div>
            <div class="w-full @if($step != 1) hidden  @endif" >
                ...
                <div class="mt-4">
                    ...
                    <x-input class="" wire:model="title" id="title" type="text" placeholder="Enter Title" />
        ...
        <div class="mt-4 text-center">
            @if(!empty($record) && ($record?->article_status?->code == '001' || $record?->article_status?->code == '012' || $record?->article_status?->code == '013'))
                ...
                <x-button type="submit" wire:click="update('001')" wire:loading.attr="disabled">
