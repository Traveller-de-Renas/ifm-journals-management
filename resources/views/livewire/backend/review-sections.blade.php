<x-module>
    ...
    <div class="w-full mt-4">
        ...
        <select wire:model="category" class="w-full mt-4 rounded-lg border-gray-200" wire:change="checkCategory($event.target.value)">
        ...
        <div class="mt-2 p-2 bg-gray-200 mb-2">Queries</div>
        <div class="">
        ...
        <div class="mt-4 text-right">
            <x-button type="submit" wire:click="store()" wire:loading.attr="disabled">Submit
            </x-button>
