    ...
    <div class="p-4 w-full">
        ...
        <ol class="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">                  
            ...
            <li class="mb-10 ms-6">
                ...
                <div class="@if ($step != 2) hidden @endif">
                    ...
                    <div class="grid grid-cols-12 gap-4 mb-2">
                        ...
                        <div class="col-span-9" @if(!$form) wire:ignore @endif>
                        ...
                        <div class="text-right">
                            <x-button-plain class="bg-red-700" wire:click="removeRow({{ $key }}, 'instructions')">
            ...
            <li class="mb-10 ms-6">
                <div class="flex items-center justify-start cursor-pointer" wire:click="setStep(4)">     
                    ...
                    <h3 class="font-medium leading-tight" wire:click="setStep(4)">Article Type</h3>
                </div>
                ...
                <div class="@if ($step != 4) hidden @endif">
                    ...
                    <div class="grid grid-cols-12 gap-4 mb-2">
                        ...
                        <div class="text-right">
                            <x-button-plain class="bg-red-700" wire:click="removeRow({{ $key }}, 'article_types')">
                                <svg class="h-5 w-5 text-white"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polyline points="3 6 5 6 21 6" />  <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />  <line x1="10" y1="11" x2="10" y2="17" />  <line x1="14" y1="11" x2="14" y2="17" /></svg>
                            </x-button-plain>
                        </div>
                    </div>
            ...
            <li class="mb-10 ms-6">
                <div class="flex items-center justify-start cursor-pointer" wire:click="setStep(5)">     
                    ...
                    <h3 class="font-medium leading-tight" >File Categories</h3>
                </div>

                <div class="@if ($step != 5) hidden @endif">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-2">
                            <x-label for="file_category_name" value="Title" class="mb-2 block font-medium text-sm text-gray-700" />
                        </div>

                        <div class="col-span-9">
                            <x-label for="file_category_description" value="Description" class="mb-2 block font-medium text-sm text-gray-700" />
                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-4 mb-2">
                        <div class="col-span-2">
                            <x-input type="text" id="file_category_name" class="w-full" wire:model="file_category_name.{{ $key }}" />
                            <x-input-error for="file_category_name" />
                        </div>

                        <div class="col-span-9" @if(!$form) wire:ignore @endif>
                            <x-textarea type="text" id="file_category_description" class="w-full h-10" wire:model="file_category_description.{{ $key }}" />
                            <x-input-error for="file_category_description" />
                        </div>

                        <div class="text-right">
                            <x-button-plain class="bg-red-700" wire:click="removeRow({{ $key }}, 'file_categories')">
                                <svg class="h-5 w-5 text-white"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polyline points="3 6 5 6 21 6" />  <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />  <line x1="10" y1="11" x2="10" y2="17" />  <line x1="14" y1="11" x2="14" y2="17" /></svg>
                            </x-button-plain>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-4">
                        <x-button type="button" wire:click="addRows('file_categories')" wire:loading.attr="disabled">
                            {{ __('Add More') }}
                        </x-button>
                    </div>
                </div>
            ...
            <li class="ms-6">
                ...
                <div class="@if ($step != 6) hidden @endif">
                    ...
                    <div class="grid grid-cols-12 gap-2 mb-2">
                        <div class="col-span-11" @if(!$form) wire:ignore @endif>
                        ...
                        <div class="text-right">
                            <x-button-plain class="bg-red-700" wire:click="removeRow({{ $key }}, 'confirmations')">
                                <svg class="h-5 w-5 text-white"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polyline points="3 6 5 6 21 6" />  <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />  <line x1="10" y1="11" x2="10" y2="17" />  <line x1="14" y1="11" x2="14" y2="17" /></svg>
                            </x-button-plain>
                        </div>
                    </div>
        ...
        <div class="mt-4">
            ...
            <div class="text-center">
                ...
                <x-button-plain class="bg-red-600" wire:loading.attr="disabled">
                    {{ __('Cancel') }}
                </x-button-plain>
                </a>
