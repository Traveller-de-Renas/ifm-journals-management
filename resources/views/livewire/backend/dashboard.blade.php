    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="w-full grid grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-red-400 p-3 rounded-md shadow-md">
                <div class="flex">
                    <div class="w-full">
                        <p class="font-bold text-xl">System Users</p>
        ...
        <div class="w-full grid grid-cols-12 gap-4 mb-6">
            ...
            <div class="col-span-6">
                <div class="h-96">
                    <livewire:livewire-column-chart
                        :column-chart-model="$callPapersChart"
                    />
                </div>
            </div>
        </div>
