<div class="w-full">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-3 px-4 py-8">
        <div class="px-4">
            ...
            <div class="space-y-4">
                {{-- <div class="mt-4">
                    <x-label for="category" class="text-xs">{{ __('Category') }} <span class="text-red-500">*</span></x-label>
                ...
                <div {{ $category == 'external' ? '' : 'hidden' }}>
                    <div class="mt-4">
                        ...
                        <x-input id="email" type="email" wire:model.live.debounce.500ms="email" placeholder="search..." type="search" required />
                    ...
                    <div {{ $user_check == 'exists' ? '' : 'hidden' }}>
                        ...
                        <x-button class="mt-4" wire:click="enroll()">Enroll to this Journal</x-button>
                    </div>
            ...
            <div class="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
                <div class="text-sm">
                    {{ __('Have an account?') }} <a class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="{{ route('journal.login',  $journal->uuid) }}">{{ __('Sign In') }}</a>
                </div>
            </div>
        </div>
    </div>
